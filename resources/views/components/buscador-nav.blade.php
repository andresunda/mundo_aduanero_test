<div class="dropdown" id="kt_quick_search_toggle">
    <!--begin::Toggle-->
    <div id="hoverNAV" class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
        ...
        <div class="quick-search quick-search-dropdown" id="kt_quick_search_dropdown">
            ...
            <div class="quick-search-form">
                <div class="input-group">
                    ...
                    <input id="texto" type="text" class="form-control" autocomplete="off" placeholder="Buscar..." />
