       ...
       <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span style="background-color: purple; color: white!important; padding: 3px; border-radius: 1rem;" class="card-label font-weight-bolder text-dark">World Trade E-learning</span>
           </h3>
