    ...
    <div class="card-body">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span style="background-color: white!important;" class="symbol-label">
                    <img src="{{asset('media/users/300_4.jpg')}}" class="h-75 align-self-end" alt=""/>
                </span>
            </div>
            <!--end::Symbol-->
            ...
            <div class="d-flex flex-column flex-grow-1">
                <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Ruby Gomez</a>
                <span class="text-muted font-weight-bold">Jueves a las 5:06 PM</span>
            </div>
            <!--end::Info-->

            <!--begin::Dropdown-->
            <div class="dropdown dropdown-inline ml-2"  data-placement="left">
                <a href="#" class="btn btn-hover-light-primary btn-sm btn-icon" data-toggle="" aria-haspopup="true" aria-expanded="false">
...
<!--end::Navigation-->
        ...
        <div class="pt-4">
            ...
            <div class="bgi-no-repeat bgi-size-cover rounded min-h-265px" style="background-image: url('{{asset('media/stock-900x600/3.jpg')}}')"></div>
            <!--end::Image-->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <form class="position-relative">
            <textarea id="kt_forms_widget_4_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1" placeholder="Comentar..."></textarea>
    ...
    <div class="card-body">
        ...
        <div>
            ...
            <div class="d-flex align-items-center pb-4">
                ...
                <div class="symbol symbol-40 symbol-light-success mr-5">
                <span style="background-color: white!important;" class="symbol-label">
                    <img src="{{asset('media/users/300_1.jpg')}}" class="h-75 align-self-end" alt=""/>
                </span>
            </div>
                <!--end::Symbol-->
                ...
                <!--begin::Info-->
                <div class="d-flex flex-column flex-grow-1">
                    <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Javier Hernandez</a>
                    <span class="text-muted font-weight-bold">Martes a las 5:06 PM</span>
                </div>
                <!--end::Info-->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M16.5,4.5 C14.8905,4.5 13.00825,6.32463215 12,7.5 C10.99175,6.32463215 9.1095,4.5 7.5,4.5 C4.651,4.5 3,6.72217984 3,9.55040872 C3,12.6834696 6,16 12,19.5 C18,16 21,12.75 21,9.75 C21,6.92177112 19.349,4.5 16.5,4.5 Z" fill="#000000" fill-rule="nonzero"/>
                ...
                <div class="d-flex py-5">
                    ...
                    <div class="symbol symbol-40 symbol-light-success mr-5">
                <span style="background-color: white!important;" class="symbol-label">
                    <img src="{{asset('media/users/300_10.jpg')}}" class="h-75 align-self-end" alt=""/>
                </span>
            </div>
                    <!--end::Symbol-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder pr-6">Martha Marin</a>
                            <span class="text-muted font-weight-normal flex-grow-1 font-size-sm">Hace 1 dia</span>
                            <span class="text-muted font-weight-normal font-size-sm">comentario</span>
                        </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="symbol symbol-40 symbol-light-success mr-5">
                <span style="background-color: white!important;" class="symbol-label">
                    <img src="{{asset('media/users/300_11.jpg')}}" class="h-75 align-self-end" alt=""/>
                </span>
            </div>
                    <!--end::Symbol-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid">
                        <!--begin::Info-->
                        <div class="d-flex align-items-center flex-wrap">
                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder pr-6">Vanesa Valadez</a>
                            <span class="text-muted font-weight-normal flex-grow-1 font-size-sm">Hace 2 dias</span>
                            <span class="text-muted font-weight-normal font-size-sm">comentario</span>
                        </div>
        ...
        <!--begin::Editor-->
        <form class="position-relative">
            <textarea id="kt_forms_widget_5_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1" placeholder="Comentar..."></textarea>
