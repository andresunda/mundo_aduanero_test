<div id="hoverNAV" class="topbar-item">
    <div  class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
        <span style="color: white!important;" class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Bienvenido</span>
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
            ...
            <div class="d-flex flex-column">
                <a href="{{route('perfil')}}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
                {{Auth::user()->name}}
				</a>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <circle fill="#000000" opacity="0.3" cx="19.5" cy="17.5" r="2.5"/>
					...
					<a href="#" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Cerrar Sesión</a>
                </div>
            </div>
        </div>
		<!--end::Header-->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		...
		<!--begin::Notifications-========================================888888888888888888888888888888888888888888888888========--->
