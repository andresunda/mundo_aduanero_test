        ...
        <div class="d-flex align-items-center">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span class="symbol-label">
                    <img src="{{asset('img/logop.png')}}" class="h-75 align-self-end" alt=""/>
                </span>
            </div>
            <!--end::Symbol-->
            ...
            <div class="d-flex flex-column flex-grow-1">
                <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Coca Cola</a>
                <span class="text-muted font-weight-bold">Anuncio</span>
            </div>
            <!--end::Info-->
...
<!--end::Navigation-->
        ...
        <div class="pt-4">
            <!--begin::Image-->
            <div class="bgi-no-repeat bgi-size-cover rounded min-h-265px" style="background-image: url('{{asset('img/publi.jpg')}}')"></div>
            <!--end::Image-->

            <!--begin::Text-->
            <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-2">
            Aprovecha esta promoción, disponible solo en tiendas OXXO
            </p>
            <!--end::Text-->
