<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span style="background-color: black; padding: 3px; border-radius: 1rem; color: white!important;" class="card-label font-weight-bolder text-dark">TV Programación</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Finanzas inicia en <span class="text-primary">7 mins</span></span>
        </h3>
