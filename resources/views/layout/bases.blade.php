<div id="kt_header" style="left: 0px; left: 0px; color: white!important;" class="colorb header  header-fixed " >
	...
	<!--============begin::Header Menu============================================-->
    <img style="margin-top: .5rem;" src=" {{asset('media/logos/logo.png')}}" class="max-h-75px" alt=""/>
				<!--end::Header Menu-->
			</div>
    ...
    <div class="quick-search-wrapper scroll" data-scroll="true" data-height="325" data-mobile-height="200">
		            ...
		            <!--end::Search00000000000000000000000000000000000000000000000000000-->
		        ...
		        <!--end::Languages-->
		            ...
		            <div class="topbar-item">
		                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
							<span style="color: white!importnat;" class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Bienvenido</span>
